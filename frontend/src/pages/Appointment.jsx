    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg">
            ...
            <div className="sm:ml-72 sm:pl-4 mt-6 font-medium text-gray-700">
                ...
                <div className="flex space-x-4 overflow-x-auto">
                    {
                        ...
                        border border-gray-300 transition duration-300 ease-in-out transform hover:scale-105 hover:bg-[#6a4cfc] hover:text-white`}
                            >
                                ...
                                <p className="font-semibold text-lg">{item[0] && item[0].dateTime.getDate()}</p>
                            </div>
                        ))
                    }
                </div>
                ...
                <button className="bg-primary text-sm sm:text-base text-[#ffffff] px-8 py-3 rounded-full mt-6 hover:scale-105 transition-all">Book an appointment</button>
            </div>
